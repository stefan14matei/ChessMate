...
import com.example.chessmate.repository.StatsRepositoryImpl
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideStatsRepository(api: ChessApi, statsCacheDao: StatsCacheDao): StatsRepository {
        return StatsRepositoryImpl(api, statsCacheDao)
    }
}